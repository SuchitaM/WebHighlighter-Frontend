...
!function () {
    var $, Annotator, Delegator, LinkParser, Range, Util, findChild, fn, functions, g, getNodeName, getNodePosition, gettext, simpleXPathJQuery, simpleXPathPure, _Annotator, _gettext, _i, _j, _len, _len1, _ref, _ref1, _t, __slice = [].slice, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
    ...
    Annotator = function (_super) {
        ...
        Annotator.prototype.events = {
            ...
            ".downvoted_highlight mouseover" : "onHighlightMouseover",
        ...
        Annotator.prototype.setupAnnotation = function (annotation) {
            ...
            _len3 = normedRanges.length; _l < _len3; _l++) {
                ...
                var cssClass = null;
                if(annotation.votes && annotation.votes<0)
                    cssClass = "downvoted_highlight";
    ...
    Annotator.Viewer = function (_super) {
        ...
        Viewer.prototype.events = {
            ".annotator-upvote click": "onEditClick",
            ".annotator-downvote click": "onDeleteClick"
        };
        ...
        Viewer.prototype.html = {
            ...
            item: '<li class="annotator-annotation annotator-item">\n  <span class="annotator-controls">\n    <a href="#" title="View as webpage" class="annotator-link">View as webpage</a>\n  <span class="votes">0</span>  <button title="Upvote" class="annotator-upvote">Upvote</button>\n    <button title="Downvote" class="annotator-downvote">Downvote</button>\n  </span>\n</li>'
        };
        ...
        Viewer.prototype.load = function (annotations) {
            ...
            _len2 = _ref2.length; _k < _len2; _k++) {
                ...
                if(annotation.votes){
                    var htmlitems = item.html().split("0");
                    if(htmlitems.length>1)
                        item.html(htmlitems[0] + annotation.votes + htmlitems[1]);    
                }
        ...
        Viewer.prototype.onEditClick = function (event) {
            this.onButtonClick(event, "upvote");
        }
        ;
        Viewer.prototype.onDeleteClick = function (event) {
            this.onButtonClick(event, "downvote");
        }
        ;
        Viewer.prototype.onButtonClick = function (event, type) {
            var item;
            item = $(event.target).parents(".annotator-annotation");
            var ann_id = item.data("annotation")._id;
            data ={};
            this.publish("delete", [item.data("annotation")]);
       		this.sendRequestToServer("https://webharvester.herokuapp.com/api/store/annotations/"+type+"/"+ann_id,"PUT",data);
        }
        ;
        Viewer.prototype.sendRequestToServer = function(url,method,data,callback)
        {
        console.log(url);
        $.ajax({
            url:url,
            ...
            success:function(response) {
            		...
            		var vote_annotator = $(document.body).annotator();
            		vote_annotator.annotator('loadAnnotations',[response]);
	            }
         });	
        };	
